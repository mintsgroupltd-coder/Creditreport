  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-surface px-6">
      <form onSubmit={handleSubmit} className="w-full max-w-sm rounded-xl border border-border bg-panel p-8">
        ...
        <p className="mt-1 text-sm text-slate-400">Upload and analyse your credit report.</p>

        <label htmlFor="signup-email" className="mt-6 block text-xs font-medium uppercase tracking-wide text-slate-400">
          Email
        </label>
        <input
          id="signup-email"
        ...
        <label htmlFor="signup-password" className="mt-4 block text-xs font-medium uppercase tracking-wide text-slate-400">
          Password
        </label>
        <input
          id="signup-password"
